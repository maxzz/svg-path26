...
type ScalePreviewData = { path: string; bounds: SelectionBounds; };

function ScalePreviewPane({ preview, fillPreview, strokeWidth }: { preview: ScalePreviewData | null; fillPreview: boolean; strokeWidth: number; }) {
    if (!preview) {
        return (
